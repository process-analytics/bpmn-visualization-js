...
In `ShapeConfigurator`, we customize the mxShape rendering code to add extra CSS classes depending on BPMN Elements kind.
This let managing styling with external CSS classes and is used for elements identification and selection.
