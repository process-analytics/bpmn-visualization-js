...
- `npm run test` _Run all tests_
- `npm run test:unit` _Run unit tests_
- `npm run test:unit:coverage` _Run unit tests with coverage_
- `npm run test:e2e` _Run end-to-end tests_.
- `npm run test:e2e:coverage` _Run end-to-end tests with coverage_
- `npm run test:e2e:verbose` _Run end-to-end tests with debug logs_
- `npm run test:integration` _Run integration tests_.
- `npm run test:integration:coverage` _Run integration tests with coverage_
- `npm run test:perf` _Run performance tests_
- `npm run test:perf:verbose` _Run performance tests with debug logs_
- `npm run test:bundles` _Run bundles tests_
- `npm run test:bundles:verbose` _Run bundles tests with debug logs_
