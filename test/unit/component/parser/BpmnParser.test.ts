...
describe('parse xml to model', () => {
  it('Single process with no participant', () => {
    // Xml taken from https://github.com/bpmn-miwg/bpmn-miwg-test-suite/blob/b1569235563b58d7216caa880c447bafee3e23cf/Reference/A.1.0.bpmn
    const bpmnAsXml = `<?xml version="1.0" encoding="ISO-8859-1" standalone="yes"?>
