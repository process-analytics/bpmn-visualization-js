...
describe('parse bpmn as json for label font', () => {
  ...
  it("should convert as Shape without Label, when a BPMNShape (attached to callActivity & with empty BPMNLabel) is an attribute (as object) of 'BPMNPlane' (as object)", () => {
    const json = {
      definitions: {
        targetNamespace: '',
        process: [
          {
            id: 'Process_1',
            callActivity: { id: 'source_id_0', name: `call activity`, calledElement: 'Process_2' },
          },
          { id: 'Process_2' },
        ],
        BPMNDiagram: {
