...
describe('compute all css class names based on style input', () => {
  it.each`
    ...
    ${'intermediateThrowEvent;bpmn.eventDefinitionKind=link;linkEventTargetId=target_id'}                | ${false} | ${['bpmn-type-event', 'bpmn-intermediate-throw-event', 'bpmn-event-def-link']}
    ${'intermediateCatchEvent;bpmn.eventDefinitionKind=link;linkEventSourceIds=source_id_1,source_id_2'} | ${false} | ${['bpmn-type-event', 'bpmn-intermediate-catch-event', 'bpmn-event-def-link']}
