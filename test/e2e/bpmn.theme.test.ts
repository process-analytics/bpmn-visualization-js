...
describe('BPMN theme', () => {
  // chromium max: 0.9735415704288708%
  // firefox max for all OS: 0.10775084631386989%
  // webkit max: 0.10454002395935413%
  const imageSnapshotConfigurator = new ImageSnapshotConfigurator(
    new MultiBrowserImageSnapshotThresholds({ chromium: 0.98 / 100, firefox: 0.11 / 100, webkit: 0.105 / 100 }),
    'theme',
  );
