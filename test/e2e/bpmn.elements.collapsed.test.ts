...
const getElementsToCollapse = (bpmnDiagramName: string): Array<string> => {
  ...
  // add none to test the diagram rendering without collapsing any element. There is no element in diagrams with the 'none' id, to the value is ignored in the page
