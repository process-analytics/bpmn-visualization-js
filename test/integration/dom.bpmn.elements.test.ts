  ...
  `('container set with "$type"', ({ bpmnVisualization }: { bpmnVisualization: BpmnVisualization }) => {
    ...
    describe('Get by kinds', () => {
      ...
      it('Pass a several kinds that all match existing elements', async () => {
        ...
        expectEndEventBpmnElement(bpmnElements[0], { id: 'endEvent_message_1', name: 'message end 2' });
        expectEndEventBpmnElement(bpmnElements[1], { id: 'endEvent_terminate_1', name: 'terminate end 1' });
      ...
      it('Pass a several kinds that match existing and non-existing elements', async () => {
        ...
        expectServiceTaskBpmnElement(bpmnElements[0], { id: 'serviceTask_2_1', name: 'Service Task 2.1' });
        expectServiceTaskBpmnElement(bpmnElements[1], { id: 'serviceTask_1_2', name: 'Service Task 1.2' });
      });
    });
  });
});
