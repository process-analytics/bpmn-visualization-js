...
async function saveAndRegisterImages(matcherContext: MatcherContext, received: Buffer, options: MatchImageSnapshotOptions): Promise<void> {
  ...
  // TODO could use async as the function is async
  // TODO move this copy to the toMatchImageSnapshotCustom function (the image processing is done their, here we should only attach the images to the report)
  ...
  // TODO here we should use options.customReceivedDir
