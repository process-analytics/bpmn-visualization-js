...
import { mxConstants, mxUtilities } from '../../initializer';
...
export function buildPaintParameter({
  ...
  const shapeStrokeWidth = mxUtilities.getValue(shape.style, mxConstants.STYLE_STROKEWIDTH, StyleDefault.STROKE_WIDTH_THIN);
  const fillColor = mxUtilities.getValue(shape.style, mxConstants.STYLE_FILLCOLOR, StyleDefault.DEFAULT_FILL_COLOR);
  const strokeColor = mxUtilities.getValue(shape.style, mxConstants.STYLE_STROKECOLOR, StyleDefault.DEFAULT_STROKE_COLOR);
  const margin = mxUtilities.getValue(shape.style, mxConstants.STYLE_MARGIN, StyleDefault.DEFAULT_MARGIN);
