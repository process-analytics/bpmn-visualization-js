...
export class IconPainter {
   ...
   *
   * This is also the entry point of the icon painting methods contributed by the extensions. It can stay protected:
   * such a method declares `this` as an {@link IconPainter}, which is enough for TypeScript to grant it access.
   *
