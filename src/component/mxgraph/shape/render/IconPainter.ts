...
export default class IconPainter {
  ...
  paintHandIcon({ setIconOrigin, c, shape, ratioFromParent, icon }: PaintParameter): void {
    const originalIconSize = { width: 426.09, height: 354.12 };
    const canvas = this.newBpmnCanvas({ c, ratioFromParent, setIconOrigin, shape, icon }, originalIconSize);

    canvas.begin();
    canvas.moveTo(314.1, 336.39);
    canvas.curveTo(323.28, 316.9, 302.97, 306.93, 302.97, 306.93);
    canvas.curveTo(297.64, 303.68, 271.03, 287.43, 223.12, 258.19);
    canvas.lineTo(228.77, 248.39);
    canvas.curveTo(306.42, 269.38, 349.56, 281.05, 358.19, 283.38);
    canvas.curveTo(358.19, 283.38, 379.69, 288, 383.86, 267.77);
    canvas.curveTo(388.78, 245.29, 370.76, 238.63, 370.76, 238.63);
    canvas.curveTo(362.35, 236.44, 320.3, 225.48, 244.62, 205.75);
    canvas.lineTo(247.64, 194.8);
    canvas.curveTo(338.33, 204.4, 388.71, 209.74, 398.78, 210.8);
    canvas.curveTo(398.78, 210.8, 422.33, 212.16, 424.2, 189.55);
    canvas.curveTo(426.09, 166.93, 402.94, 164.13, 402.94, 164.13);
    canvas.curveTo(392.87, 163.1, 342.48, 157.99, 251.79, 148.77);
    canvas.lineTo(251.79, 138.97);
    canvas.curveTo(335.85, 132.12, 382.56, 128.32, 391.9, 127.56);
    canvas.curveTo(391.9, 127.56, 414.72, 122.38, 414.72, 102.61);
    canvas.curveTo(414.72, 82.85, 387.92, 81.87, 387.92, 81.87);
    canvas.curveTo(376.43, 82.21, 318.98, 83.88, 215.57, 86.9);
    canvas.lineTo(210.05, 81.87);
    canvas.curveTo(227.74, 59.39, 237.56, 46.91, 239.53, 44.41);
    canvas.curveTo(239.53, 44.41, 253.56, 26.8, 239.22, 12.72);
    canvas.curveTo(226.27, 0, 206.52, 14.49, 206.52, 14.49);
    canvas.curveTo(198.9, 19.42, 160.79, 44.06, 92.21, 88.43);
    canvas.lineTo(82.44, 251.94);
    canvas.curveTo(205.28, 308.79, 273.53, 340.37, 287.18, 346.69);
    canvas.curveTo(287.18, 346.69, 305.35, 354.12, 314.1, 336.39);
    canvas.fillAndStroke();
    canvas.begin();
    canvas.moveTo(314.1, 336.39);
    canvas.curveTo(323.28, 316.9, 302.97, 306.93, 302.97, 306.93);
    ...
    canvas.fillAndStroke();
    canvas.begin();
    canvas.moveTo(0, 56.3);
    canvas.lineTo(0, 262.9);
    canvas.lineTo(60.34, 262.9);
    canvas.lineTo(72.42, 73.91);
    canvas.lineTo(27.29, 56.3);
    canvas.lineTo(0, 56.3);
    canvas.close();
    canvas.fillAndStroke();
    canvas.begin();
    canvas.moveTo(0, 56.3);
