...
export class UserTaskShape extends BaseTaskShape {
  ...
  private paintWoman(c: mxgraph.mxXmlCanvas2D, x: number, y: number, w: number, h: number): void {
    ...
    canvas.begin();
    // left hairs to the top of the left shoulder (from top to bottom)
    canvas.moveTo(141.9, 0);
    canvas.curveTo(85.52, 0, 39.66, 45.87, 39.66, 102.25);
    canvas.lineTo(39.66, 131.4);
    // starting from here, we are close to the left ear (double curve)
    ...
    canvas.lineTo(32.34, 275.52); // left shoulder start
    ...
    // extra curves: the svg bottom cut wasn't a right lane
    ...
    // left dress strap
    // canvas.moveTo(22.54, 302.47); // replacement to support 'avoid double curve'
    // canvas.moveTo(18.54, 298.47); // replacement to support 'avoid double curve'
    // canvas.lineTo(39.25, 322.51); // this doesn't go enough to the bottom: y should be around 326-328 (x to be adjusted accordingly)
    ...
    // double curve of the left dress strap
    ...
    // double curve of the left shoulder
    // canvas.curveTo(35.03, 290.96, 36.77, 289.99, 38.59, 289.16);
    // canvas.lineTo(74.53, 272.68);
    // canvas.moveTo(74.53, 272.68); // replacement to support 'avoid double curve'
    canvas.moveTo(70.53, 268.68); // replacement to support 'avoid double curve'
    ...
    //    canvas.lineTo(244.96, 289.16); // right shoulder start
    canvas.moveTo(244.96, 289.16); // replacement to support 'avoid double curve'

    // right shoulder followup + dress strap (we keep the external part)
    ...
    // dress strap (from bottom to top)
    // canvas.moveTo(241.26, 326.17); // tmp
    // // canvas.lineTo(261.01, 302.47);
    // canvas.lineTo(265.01, 298.47);

    // start of the right shoulder termination
    ...
    canvas.curveTo(244.15, 45.87, 198.28, 0, 141.9, 0); // go to top and join the left part
    // canvas.close();

    // // top right hairs to neck (bottom part --> double curves, don't keep)
    ...
    // face bottom from right to the left part of the fringe of hair cut
    // canvas.moveTo(186.13, 238.49); // right bottom face
    // canvas.moveTo(197.03, 250.68); // right bottom face + adjustment to link with the bottom (version 1)
    // canvas.moveTo(221.48, 242.7); // right bottom face + adjustment to link with the bottom (version 2)
    canvas.moveTo(186.13, 250.68); // right bottom face + adjustment to link with the bottom (version 3)
    canvas.lineTo(186.13, 220.35); // from bottom to top neck
    // canvas.moveTo(186.13, 220.35);
    ...
    // limit of the top hairs face (double curves, bottom part, from left to right)
    // // canvas.curveTo(82.63, 78.12, 82.69, 82.87, 85.66, 85.76); // double curves restart
    // canvas.moveTo(85.66, 85.76); // tmp
    ...
    // continue ear and fringe of hair cut right part
    ...
    // canvas.curveTo(91.27, 108.05, 86.63, 109.09, 84.41, 112.58); // double curves start
    ...
    // canvas.lineTo(86.67, 250.61); // vertical neck part - adjustment to link to the un-doubled curve line (version 1)
    canvas.lineTo(97.43, 250.61); // vertical neck part - adjustment to link to the un-doubled curve line (version 2)
    // start of the double curves for left hairs: from interior bottom right to left then go up
    ...
    canvas.moveTo(97.43, 220.2); // close left neck
    canvas.curveTo(121.6, 231.66, 131.55, 233.65, 141.91, 233.65);
    // canvas.curveTo(152.09, 233.65, 161.97, 231.71, 171.12, 228.13);
    canvas.curveTo(152.09, 233.65, 161.97, 231.71, 186.13, 220.35); // close right neck
    // canvas.lineTo(171.12, 240.2); // double curves: vertical right neck part
