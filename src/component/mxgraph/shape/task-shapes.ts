...
export class UserTaskShape extends BaseTaskShape {
  ...
  // adapted from icons made by freepik https://www.flaticon.com/authors/freepik
  // use mxgraph svg2xml to generate the xml stencil and port it to code
  protected paintTaskIcon(c: mxgraph.mxXmlCanvas2D, x: number, y: number, w: number, h: number): void {
    // icon height is 239 - generated by the tool (https://github.com/process-analytics/mxgraph-svg2shape)
    // It is needed here for the proper scaling of the icon
