...
abstract class EventShape extends mxEllipse {
  ...
  private iconPainters: Map<EventType, (paintParameter: PaintParameter) => void> = new Map([
    [EventType.MESSAGE, (paintParameter: PaintParameter) => this.iconPainter.paintEnvelopeIcon({ ...paintParameter, ratioFromParent: 0.5 })],
    [EventType.TERMINATE, (paintParameter: PaintParameter) => this.iconPainter.paintCircleIcon({ ...paintParameter, ratioFromParent: 0.6 })],
    [
      EventType.TIMER,
