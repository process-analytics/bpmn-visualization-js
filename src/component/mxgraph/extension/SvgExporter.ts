...
declare const mxRectangle: typeof mxgraph.mxRectangle;
declare const mxSvgCanvas2D: typeof mxgraph.mxSvgCanvas2D;
...
export default class SvgExporter {
   ...
   * Hook for creating the canvas used in getSvg.
   */
  createSvgCanvas(node: Element): mxgraph.mxSvgCanvas2D {
