...
import { computeBpmnBaseClassNames, extractBpmnKindFromStyle } from '../style-helper';
  ...
  private initMxShapePrototype(isFF: boolean): void {
    ...
    mxShape.prototype.createSvgCanvas = function () {
      ...
      if (this.state && this.state.cell) {
        ...
        const bpmnBaseClassNames = computeBpmnBaseClassNames(extractBpmnKindFromStyle(cell), this.dialect === 'strictHtml');

        this.node.setAttribute('class', bpmnBaseClassNames);
